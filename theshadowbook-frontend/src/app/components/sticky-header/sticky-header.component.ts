	...
	public ngOnInit() : void {
		...
		this.zone.runOutsideAngular(
			() => {
				...
				this.observer.observe( this.elementRef.nativeElement.children[1] );
				this.observer.observe( this.elementRef.nativeElement.children[0] );
